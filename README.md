# Samuel Glasscock - Personal Portfolio
...
## Acknowledgements
This project is based on the [Vercel Next.js Portfolio Starter](https://vercel.com/templates/next.js/portfolio-starter-kit) template, which indicates a MIT License under its `package.json`. To respect best practices, I have included a copy of the MIT License in this repo and keep Vercel's original attribution. See [MIT License](LICENSE) for full details.
